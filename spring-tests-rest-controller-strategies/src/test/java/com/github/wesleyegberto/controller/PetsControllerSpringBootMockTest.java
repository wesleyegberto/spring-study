...
// Still without a real webserver
// will boot everything (unless configured not to)
// if not specify environment or use MOCK it will be like example of MockMvcWithContextTest
@SpringBootTest
